...
----------------------------------------------------------
    ...
    "obstacle_channel.py", which functionality is to navigate 
    a USV through an obstacle channel.
	@version: 1.2
    Open source
----------------------------------------------------------
'''
...
class ObsChan:
    ...
    def compute_path(self):
        ...
        #PENDIENTE VOLVER A CHECARLO, CONTRATIEMPO CON EL STM32
